...
let ASRICO = (function ()
{
    ...
    const C_RICOPROPERTY = {
        ...
        [C.RESLOW_4] : [4, 1,   8,   0,   0,   0,   4,   4],
        [C.RESLOW_5] : [5, 1,  10,   0,   0,   0,   5,   5],
        [C.RESHIG_0] : [0, 3,   0,   0,   0,   0,   0,   0],
        [C.RESHIG_1] : [1, 3,  10,   0,   0,   0,   5,   5],
        [C.RESHIG_2] : [2, 3,  16,   0,   0,   0,   8,   8],
        [C.RESHIG_3] : [3, 3,  24,   0,   0,   0,  12,  12],
        [C.RESHIG_4] : [4, 3,  34,   0,   0,   0,  17,  17],
        [C.RESHIG_5] : [5, 3,  50,   0,   0,   0,  25,  25],
        ...
        [C.INDHIG_3] : [3, 6,   0,  24,   0,  12,   0,  12],
        [C.INDHIG_4] : [4, 6,   0,  34,   0,  17,   0,  17],
        [C.INDHIG_5] : [5, 6,   0,  50,   0,  25,   0,  25],
        [C.COMLOW_0] : [0, 7,   0,   0,   0,   0,   0,   0],
        [C.COMLOW_1] : [1, 7,   0,   0,   2,   1,   1,   0],
        [C.COMLOW_2] : [2, 7,   0,   0,   4,   2,   2,   0],
        [C.COMLOW_3] : [3, 7,   0,   0,   6,   3,   3,   0],
        [C.COMLOW_4] : [4, 7,   0,   0,   8,   4,   4,   0],
        [C.COMLOW_5] : [5, 7,   0,   0,  10,   5,   5,   0],
        [C.COMHIG_0] : [0, 9,   0,   0,   0,   0,   0,   0],
        [C.COMHIG_1] : [1, 9,   0,   0,  10,   5,   5,   0],
        [C.COMHIG_2] : [2, 9,   0,   0,  16,   8,   8,   0],
        [C.COMHIG_3] : [3, 9,   0,   0,  24,  12,  12,   0],
        [C.COMHIG_4] : [4, 9,   0,   0,  34,  17,  17,   0],
        [C.COMHIG_5] : [5, 9,   0,   0,  50,  25,  25,   0],
    };
