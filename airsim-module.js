...
let ASRICO = (function ()
{
    ...
    const C_RICOPROPERTY = {
        ...
        [C.INDLOW_1] : [1, 4,   0,   2,   0,   2,   0,   0],
        [C.INDLOW_2] : [2, 4,   0,   4,   0,   4,   0,   0],
        [C.INDLOW_3] : [3, 4,   0,   6,   0,   6,   0,   0],
        [C.INDLOW_4] : [4, 4,   0,   8,   0,   8,   0,   0],
        [C.INDLOW_5] : [5, 4,   0,  10,   0,  10,   0,   0],
        [C.INDHIG_0] : [0, 6,   0,   0,   0,   0,   0,   0],
        [C.INDHIG_1] : [1, 6,   0,  10,   0,  10,   0,   0],
        [C.INDHIG_2] : [2, 6,   0,  16,   0,  16,   0,   0],
        [C.INDHIG_3] : [3, 6,   0,  24,   0,  24,   0,   0],
        [C.INDHIG_4] : [4, 6,   0,  34,   0,  34,   0,   0],
        [C.INDHIG_5] : [5, 6,   0,  50,   0,  50,   0,   0],
